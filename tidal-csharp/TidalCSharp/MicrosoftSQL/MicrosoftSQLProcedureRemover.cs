	...
	public class MicrosoftSQLProcedureRemover : IProcedureRemover {
		...
		public void RemoveTidalStoredProcs(
			...
			using (SqlCommand command = new SqlCommand() {
                CommandText = "SELECT Name = name FROM sys.sql_modules INNER JOIN sysobjects ON sys.sql_modules.object_id = sysobjects.id WHERE name like '" + moduleName + "_%' AND definition like '%-- Generated by Tidal%';",
